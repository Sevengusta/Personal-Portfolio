          ...
          >
            ...
            >
              ...
              <div className="indicators">
                <SlideCircle active={screen1 ? true: false} slideChange={() => handleChange1()} />
                <SlideCircle active={screen2 ? true: false} slideChange={() => handleChange2()} />
                <SlideCircle active={screen3 ? true: false} slideChange={() => handleChange3()} />
              </div>
            </div>
          </div>
        </motion.div>
